          ...
          <div className="space-y-2">
            <div className="overflow-x-auto" style={{ scrollbarWidth: "none" }}>
              <div className="flex gap-2 w-max pb-1">
                <span className="text-[10px] text-white/30 uppercase tracking-wider self-center flex-shrink-0 pr-1">Tipo</span>
                {TIPOS_MIDIA.map((g) => (
                  <button key={g}
            ...
            <div className="overflow-x-auto" style={{ scrollbarWidth: "none" }}>
              <div className="flex gap-2 w-max pb-1">
                <span className="text-[10px] text-white/30 uppercase tracking-wider self-center flex-shrink-0 pr-1">Gênero</span>
                {GENRES.map((g) => (
                  <button key={g}
                    onClick={() => { setGenre(genre === g ? undefined : g); setRecentLimit(INITIAL_RECENT); }}
                    className={`px-3 py-1.5 rounded-lg text-xs font-bold border transition-all whitespace-nowrap flex-shrink-0 ${
