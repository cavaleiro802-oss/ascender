...
export default function ObraPage() {
  ...
  const { data: capitulos = [] } = trpc.capitulos.list.useQuery({ obraId, includeAll: isOwnerOrAdmin });
  ...
  // Capa: w-40 = 160px, aspect 3/4 = altura ~213px, metade = ~107px
  const CAPA_OFFSET = 107;
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* ── Hero ── */}
      {/* Wrapper externo: overflow-visible para a capa não ser cortada */}
      <div className="relative w-full" style={{ paddingBottom: CAPA_OFFSET }}>
        {/* Fundo com blur — confinado aqui com overflow-hidden */}
        ...
        {/* Capa centralizada — flutua sobre o hero sem ser cortada */}
        <div
